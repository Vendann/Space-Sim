...
namespace Space {
	public class Projectile : Flyweight, IWeaponSpawnable {
		...
		// Data
		// [SerializeField] private ProjectileData projectileDef;

		// [SerializeField] private ProjectileDefinition projectileDef;
        ...
        public void Initialize(DataWeaponExtrinsic dataWeaponExtrinsic) {
			...
			// _spawnerDirection = _dataWeaponExtrinsic.ShipRigidbody.velocity;
        ...
        private void FixedUpdate() {
			...
			_rigidbody.velocity = _spawnerVelocity + transform.forward * Definition.projVelDef.Velocity;
